package com.vision.OrderService.command.api.saga;

import com.vision.CommonService.commands.*;
import com.vision.CommonService.events.*;
...
public class OrderProcessingSaga {
    ...
    private void handle(PaymentProcessedEvent event) {
        ...
        try {
        	//TODO
           // throw new Exception() for canceling the order 
